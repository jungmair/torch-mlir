...
// -----
// CHECK-LABEL:   func @torch.overwrite.tensor$dynamic_overwrites_static(
...
// CHECK:           torch.overwrite.tensor %[[CAST]] overwrites %[[STATIC_COPY:.*]] : !torch.vtensor<[2],f32>, !torch.tensor<[2],f32>
func @torch.overwrite.tensor$dynamic_overwrites_static(%static: !torch.vtensor<[2],f32>, %dynamic: !torch.vtensor<[?],f32>) -> !torch.vtensor<[2],f32> {
  ...
  torch.overwrite.tensor %dynamic_no_type overwrites %static_copy : !torch.vtensor, !torch.tensor
...
// -----
// CHECK-LABEL:   func @torch.overwrite.tensor$static_overwrites_dynamic(
// CHECK-SAME:                                                           %[[STATIC:.*]]: !torch.vtensor<[2],f32>,
...
// CHECK:           torch.overwrite.tensor %[[CAST]] overwrites %[[DYNAMIC_COPY:.*]] : !torch.vtensor<[?],f32>, !torch.tensor<[?],f32>
func @torch.overwrite.tensor$static_overwrites_dynamic(%static: !torch.vtensor<[2],f32>, %dynamic: !torch.vtensor<[?],f32>) -> !torch.vtensor<[?],f32> {
  %static_no_type = torch.tensor_static_info_cast %static : !torch.vtensor<[2],f32> to !torch.vtensor
  %dynamic_no_type = torch.tensor_static_info_cast %dynamic : !torch.vtensor<[?],f32> to !torch.vtensor
  %dynamic_copy = torch.copy.to_tensor %dynamic_no_type : !torch.tensor
  torch.overwrite.tensor %static_no_type overwrites %dynamic_copy : !torch.vtensor, !torch.tensor
